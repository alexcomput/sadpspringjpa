...
public class RelatorioUtil {
    ...
    public final static String DIR = "/appfiles/report";
    ...
    public void imprimeRelatorio(String diretorio, ArrayList<Object> listaParametros, Connection con) throws IOException, SQLException {
